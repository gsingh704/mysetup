...
#
sudo pacman -Suy
sudo pacman -S  asusctl supergfxctl firefox  wget git base-devel nodejs npm nvidia nvidia-dkms nvidia-utils nvidia-prime  mesa mesa-demos linux-g14 linux-g14-headers linux-g14 linux-g14-headers  #lib32-nvidia-utils  bluez bluez-utils base-devel
