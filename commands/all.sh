...
#
sudo pacman -Suy
sudo pacman -S gnome-theme-extra asusctl supergfxctl firefox  wget git nodejs npm nvidia nvidia-dkms nvidia-utils #lib32-nvidia-utils nvidia-prime  mesa mesa-demos linux-g14 linux-g14-headers linux-g14 linux-g14-headers   bluez bluez-utils base-devel
